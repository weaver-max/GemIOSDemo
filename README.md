...
> · [如何判断一个功能该谁写](如何判断一个功能是否需要core写.md) ← 开发新功能前先过一遍
...
app数据来源.md            四个数据来源与后端端点清单
如何判断一个功能是否需要core写.md   决策卡片
```
...
- [App 的数据从哪来](app数据来源.md) —— 四个数据来源，含全部后端端点
- [如何判断一个功能该谁写](如何判断一个功能是否需要core写.md) —— 三步决策卡片
